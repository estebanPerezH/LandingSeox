...
export function Header() {
  const navItems = [
    { name: "Caracteristicas", href: "#features-section" },
    { name: "Precios", href: "#pricing-section" },
    { name: "Testimonios", href: "#testimonials-section" }, // Changed from Docs to Testimonials
  ]
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-3">
            <span className="text-foreground text-xl font-semibold">SEOX</span>
          </div>
