  ...
  const pricingPlans = [
    {
      ...
      monthlyPrice: "$0",
      annualPrice: "$0",
      description: "Ideal para pequeños negocios que inician en SEO.",
      features: [
        "Análisis SEO básico de tu sitio web",
        "Reporte mensual de palabras clave",
        "1 proyecto SEO",
        "Soporte por email",
    ...
    },
    {
      ...
      monthlyPrice: "$29",
      annualPrice: "$24",
      description: "Para agencias y profesionales del marketing digital.",
      features: [
        "Análisis SEO avanzado y auditoría técnica",
        "Seguimiento de hasta 100 palabras clave",
        "5 proyectos SEO",
    ...
    },
    {
      ...
      monthlyPrice: "$199",
      annualPrice: "$159",
      description: "Soluciones SEO a medida para grandes empresas.",
      features: [
        "Soporte dedicado y consultoría personalizada",
        "Proyectos SEO ilimitados",
        "Integración con Google Data Studio",
        "Acceso API para automatizaciones",
        "Reportes personalizados y branding",
      ...
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Planes de SEO para cada etapa de tu negocio
          </h2>
          <p className="self-stretch text-center text-muted-foreground text-sm font-medium leading-tight">
            Elige el paquete que mejor se adapte a tus objetivos de posicionamiento web.<br />
            Desde emprendedores hasta grandes empresas, tenemos la solución SEO ideal para ti.
          </p>
        </div>
        <div className="pt-4">
